        ...
        //niggers are black = (NO SHIT SHERLOCK);
            ...
            public void onUpdate(){
                ...
                hoodToPos(hoodAngle);
                Storage.currentX = follower.getPose().getX();
                Storage.currentY = follower.getPose().getX();
                Storage.currentHeading = follower.getHeading();
                Storage.currentPose = follower.getPose();
                telemetry.addData("Data:",follower.getPose());
                telemetry.update();
