...
//@TeleOp(name = "Solo TeleOP")
//@Configurable
//public class SoloTeleOP extends NextFTCOpMode {
//
//    public SoloTeleOP() {
//        addComponents(
//                new SubsystemComponent(Flywheel.INSTANCE, DistanceRed.INSTANCE),
...
//                transferOn,
//                closeTransfer,
//                new FollowPath(paths.toIntakeSet1, true, 1.0),
//                new Delay(1.6),
//                new FollowPath(paths.launchFromSet1, true, 1.0),
//                shoot,
//                intakeMotorOn,
...
//                transferOn,
//                closeTransfer,
//                new FollowPath(paths.toIntakeSet2, true, 1.0),
//                new Delay(1.6),
//                new FollowPath(paths.launchFromSet2, true, 1.0),
//                shoot,
//                intakeMotorOn,
...
//                transferOn,
//                closeTransfer,
//                new FollowPath(paths.toIntakeSet3, true, 1.0),
//                new Delay(1.6),
...
//        follower.update();
//
//        // At 117s, cancel the routine and start parking
...
//        }
//
//        // Shut down when park path finishes OR 119.5s safety cutoff
...
//        public PathChain parkPath;
//
//        public PathChain toIntakeSet1;
//        public PathChain launchFromSet1;
//        public PathChain toIntakeSet2;
//        public PathChain launchFromSet2;
//        public PathChain toIntakeSet3;
//        public PathChain launchFromSet3;
//
//        public Paths(Follower follower) {
//
...
//                    .build();
//
//            toIntakeSet1 = follower.pathBuilder().addPath(
//                            new BezierCurve(
//                                    new Pose(92.000, 94.000),
//                                    new Pose(50.000, 87.000),
...
//                    .build();
//
//            toIntakeSet2 = follower.pathBuilder().addPath(
//                            new BezierCurve(
//                                    new Pose(92.000, 94.000),
//                                    new Pose(57.000, 56.798),
...
//                    .build();
//
//            toIntakeSet3 = follower.pathBuilder().addPath(
//                            new BezierCurve(
//                                    new Pose(92.000, 94.000),
//                                    new Pose(54.000, 89.500),
//                                    new Pose(67.000, 28.615),
...
//                    PathChain dynamicIntake = follower.pathBuilder().addPath(
//                                    new BezierCurve(
//                                            curr,
//                                            new Pose(104.000, 67.000),
//                                            new Pose(132.5, 62.25)
//                                    )
//                            ).setLinearHeadingInterpolation(curr.getHeading(), Math.toRadians(30))
//                            .setVelocityConstraint(1.0)
//                            .setTValueConstraint(0.8)
//                            .addTemporalCallback(0.1, intakeMotorOn)
//                            .addTemporalCallback(0.1, transferOn)
//                            .build();
//
//                    new FollowPath(dynamicIntake, true, 1.0).schedule();
//                }),
//                new Delay(1.6),
//                new FollowPath(paths.launchSpam2, true, 1.0),
//                shoot,
...
//                                    new Pose(92, 94)
//                            )
//                    ).setLinearHeadingInterpolation(Math.toRadians(30), Math.toRadians(46))
//                    .setVelocityConstraint(0.3)
//                    .setTValueConstraint(0.95)
//                    .addPoseCallback(new Pose(118, 64), reverseIntakeForMe, 0.4)
//                    .build();
