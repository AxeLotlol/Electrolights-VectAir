...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "TeleOpRedNoPedro")
public class TeleOpRedNoPedro extends NextFTCOpMode {

    public MotorEx intakeMotor;
    public MotorEx transfer;
    public TeleOpRedNoPedro() {
        addComponents(
                new SubsystemComponent(DistanceRed.INSTANCE, TempHood.INSTANCE, PositionalHood.INSTANCE,  DriveTrain2.INSTANCE/*, Intake.INSTANCE, Spindexer.INSTANCE*/),
